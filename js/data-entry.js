...
function showNewPlaceForm(map,lat,lng){
    ...
    // Store the marker object and its coordinates in the array
    //places.push({ marker: place, lat: lat, lng: lng });
    ...
    popupContent += "<img class='category-option' src='images/eat.png' alt='Eat' data-value='Eat'>";
